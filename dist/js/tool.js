...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getFiles: function getFiles() {
      ...
      this.fetching = true;
      Nova.request().get('/nova-vendor/file-explorer/files?disk=' + this.selectedDisk + '&path=' + path).then(function (response) {
    ...
    getConfig: function getConfig() {
      ...
      Nova.request().get('/nova-vendor/file-explorer/files/disks').then(function (response) {
        _this2.disks = response.data.disks;
        _this2.selectedDisk = response.data.default;
        _this2.title = response.data.title;
      });
    },
    openDirectory: function openDirectory(directory) {
      this.path.push(directory);
    },
    closeDirectory: function closeDirectory() {
      this.path.pop();
    }
  }
});
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("label", { staticClass: "text-lg", attrs: { for: "select" } }, [
        _vm._v("Select a disk to explore:")
      ]),
      _vm._v(" "),
      _c(
        "select",
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.selectedDisk,
              expression: "selectedDisk"
            }
          ],
          staticClass: "mb-6 text-lg p-2",
          attrs: { id: "select" },
          on: {
            change: function($event) {
              ...
              _vm.selectedDisk = $event.target.multiple
                ? $$selectedVal
                : $$selectedVal[0]
            }
          }
        ...
        _vm._l(_vm.disks, function(disk) {
          return _c("option", { key: disk, domProps: { value: disk } }, [
            _vm._v("\n      " + _vm._s(disk) + "\n    ")
          ])
        }),
        0
            ...
            _c("table", { staticClass: "table w-full" }, [
              _c("thead", [
                _c("tr", [
                  ...
                  _vm._v(" "),
                  _c("th", { staticClass: "w-1/4", attrs: { colspan: "1" } }, [
                    _vm._v(
                      "\n            " +
                        _vm._s(_vm.files.length ? "Download" : "") +
                        "\n          "
                    )
                  ])
                ])
              ...
              _vm.fetching
                ? _c("tbody", [
                    _c("tr", [
                      _c("td", { attrs: { colspan: "2" } }, [_c("loader")], 1)
                    ])
                  ])
                : _c(
                    "tbody",
                              ...
                              [
                                ...
                                _c(
                                  "button",
                                  {
                                    on: {
                                      click: function($event) {
                                        return _vm.openDirectory(directory)
                                      }
                                    }
                                  },
                                  [
